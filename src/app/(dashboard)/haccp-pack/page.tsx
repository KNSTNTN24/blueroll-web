...
export default function HaccpPackPage() {
  ...
  function handleExportPDF() {
    ...
    for (const section of HACCP_SECTIONS) {
      ...
      const stats = sectionStats(section.id as SectionId)
    ...
    html += `<div class="footer">Generated by Blueroll · blueroll.app · ${totalXP} XP · Level ${currentLevel.level}: ${currentLevel.name}</div></body></html>`
